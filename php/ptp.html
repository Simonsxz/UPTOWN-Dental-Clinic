	...
	<section id="content">
		...
		<main>
			...
			<div class="info-container">
                <h2 class="info-title">Proposed Treatment Plans</h2>
                <form class="details-form1">
                    <textarea id="treatment-plans" name="treatment-plans" class="form-textarea" placeholder="Describe the proposed treatment plans here.." rows="5" style="width: 100%;" required></textarea>
                </form>
            </div>
