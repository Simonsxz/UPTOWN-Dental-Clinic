...
<body>
                        ...
                        <div class="welcome-dashboard-content-container">
                            ...
                            <div class="horizontal-nav-bar">
                                ...
                                <a href="add_prescription.php?patient_id=<?php echo urlencode($_SESSION['patient_id']); ?>" class="nav-item-link" onclick="return false;">
                                    <button class="nav-item active" disabled style="cursor: not-allowed;">Prescription</button>
                                </a>
    ...
    <form class="details-form1" id="prescriptionForm">
        <!-- Prescription Title (patient_prescription) -->
        <label for="note-title">Prescription Title:</label>
        <input 
            type="text" 
            id="note-title" 
            name="note-title" 
            ...
            style="width: 100%; padding: 10px; font-size: 16px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; color: #333; margin-bottom: 15px;" 
            required
        />

        <!-- Notes Text Area -->
        <label for="treatment-plans">Patient Notes:</label>
        <textarea 
            id="treatment-plans" 
